...
CREATE TABLE IF NOT EXISTS menus (
    ...
    slug            VARCHAR(100) DEFAULT NULL UNIQUE COMMENT 'Slug único para URL pública do cardápio',
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    customer_name       VARCHAR(150) DEFAULT NULL COMMENT 'Nome do cliente (para pedidos sem cadastro)',
